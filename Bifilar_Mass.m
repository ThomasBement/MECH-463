...
title('Nodal Position vs. String Length Ratio [Mass Based Coordinates]')
...
title('Mode Shape Factor vs. String Length Ratio [Mass Based Coordinates]')
xlabel('String Length Ratio,  L2/L1')
...
title('Natural Frequency vs. String Length Ratio [Mass Based Coordinates]')
xlabel('String Length Ratio,  L2/L1')
